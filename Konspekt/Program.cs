...
//Pärast tingimust on koodiplokk {}.
    ...
    //            filmid = DoYouLikeThisMovie(filmid, "Transformers");
    ...
    //                    Console.WriteLine("Lisasin filmi");
    //                }
    //                else
    //                {
    ...
    //            Console.WriteLine("Mis on su lemmikfilmid, sisesta ükshaaval, kui sisestada rohkem ei taha, sisesta ei ole");
    //            string sisestus = "";
    ...
    //else if (parool != "")
    //{
    // Console.WriteLine("Hanna, parool vale");
    //}
    //for 
    //{
